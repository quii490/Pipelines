...
declare -a shell_tools=(
  ...
  "CUTnRUN/tools/cutrun_cli/cutrun_annotate_peaks|docs/content/tools/cutrun/signal-peaks.md"
  ...
  "CUTnRUN/tools/cutrun_cli/cutrun_homer.sh|docs/content/tools/cutrun/signal-peaks.md"
...
declare -a python_tools=(
  "CUTnRUN/tools/cutrun_cli/cutrun_consensus_peaks.py|docs/content/tools/cutrun/signal-peaks.md"
  "CUTnRUN/tools/cutrun_cli/cutrun_peak_overlap.py|docs/content/tools/cutrun/signal-peaks.md"
  "CUTnRUN/tools/cutrun_cli/cutrun_report.py|docs/content/tools/cutrun/recovery-report.md"
  "CUTnRUN/tools/cutrun_cli/cutrun_results_summary.py|docs/content/tools/cutrun/recovery-report.md"
  ...
  "CUTnRUN/tools/cutrun_cli/cutrun_te_qc.py|docs/content/tools/cutrun/recovery-report.md"
)
